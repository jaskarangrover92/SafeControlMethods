% This code plots some trajectories starting from inside the safe region,
% and shows how the safe set algorithm keeps them contained in the safe
% region
clear all;
close all;
clc;
...
for m = 1 : M
        ...
        x0       = [rand-0.5 3*(rand-0.5)]';
        phi      = ((x0(1)^2) - (pi/2)^2) + (2*k*x0(1)*x0(2));
        psi      = (x0(1)^2) - (pi/2)^2;
        xdot     = dynamics(t,x0);
